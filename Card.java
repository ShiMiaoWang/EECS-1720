...
public class Card {
	 ...
	 */
	public enum Rank {
		ONE(1), TWO(2), THREE(3), FOUR(4), FIVE(5), SIX(6), QUEEN(10), KING(11), MYRIAD(12), DIVINE(13);
	...
	public Card(Suit suit, Rank rank) {
		this.suit = suit;
		this.rank = rank;
		// Automatically determine if the card is special based on its rank.
		this.isSpecial = (rank == Rank.QUEEN || rank == Rank.KING || rank == Rank.MYRIAD || rank == Rank.DIVINE);
	...
	/**
	 * Checks if the card is a special card (Queen, King, Myriad, Divine).
	 *
